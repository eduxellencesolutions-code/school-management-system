...
export async function GET() {
  ...
  // Step 1: learner details + their current class
  ...
  // Step 2: class names, fetched separately to avoid nested-join FK ambiguity
  ...
  // Step 3: attendance rate, latest available per learner (no term filter — parents want current standing)
  ...
  // Step 4: latest published broadsheet average per learner, per class
