...
// or issuing from a single student's profile page. Relocated from
// invoices/bulk-issue/route.ts, where this logic was living under the wrong
// name (that path now holds the real bulk-issue-to-a-class logic instead).
