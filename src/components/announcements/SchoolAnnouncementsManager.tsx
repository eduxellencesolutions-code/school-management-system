...
export default function SchoolAnnouncementsManager({ organizationId }: { organizationId: string }) {
  ...
  async function load() {
    setLoading(true)
    const res = await fetch(`/api/admin/announcements?orgId=${organizationId}`)
