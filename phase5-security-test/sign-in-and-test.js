// sign-in-and-test.js
// Tests: set_onboarding_deadline (admin), get_student_onboarding_status (student),
//        get_onboarding_monitor (admin)
...
if (!SUPABASE_URL || !SUPABASE_ANON_KEY) {
  console.error('Missing env vars. Ensure .env.local path is correct and contains:')
...
// ⚠️ Fill in the admin password below. Do not commit this file.
